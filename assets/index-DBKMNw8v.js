...
#endif`,bg="gl_FragColor = linearToOutputTexel( gl_FragColor );",yg=`vec4 LinearTransferOETF( in vec4 value ) {
	return value;
}
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:vi,depthTest:!1,depthWrite:!1})}function Nv(n,e,t){const i=new Float32Array(or),r=new Y(0,1,0);return new Ei({name:"SphericalGaussianBlur",defines:{n:or,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:Ko(),fragmentShader:`
		...
		`,blending:vi,depthTest:!1,depthWrite:!1})}function lf(){return new Ei({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ko(),fragmentShader:`
		...
		`,blending:vi,depthTest:!1,depthWrite:!1})}function cf(){return new Ei({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ko(),fragmentShader:`
	...
	`}function Ov(n){let e=new WeakMap,t=null;function i(l){if(l&&l.isTexture){const c=l.mapping,u=c===xl||c===gl,h=c===jr||c===qr;if(u||h){let d=e.get(l);const x=d!==void 0?d.texture.pmremVersion:0;if(l.isRenderTargetTexture&&l.pmremVersion!==x)return t===null&&(t=new of(n)),d=u?t.fromEquirectangular(l,d):t.fromCubemap(l,d),d.texture.pmremVersion=l.pmremVersion,e.set(l,d),d.texture;if(d!==void 0)return d.texture;{const g=l.image;return u&&g&&g.height>0||h&&g&&r(g)?(t===null&&(t=new of(n)),d=u?t.fromEquirectangular(l):t.fromCubemap(l),d.texture.pmremVersion=l.pmremVersion,e.set(l,d),l.addEventListener("dispose",s),d.texture):null}}}return l}function r(l){let c=0;const u=6;for(let h=0;h<u;h++)l[h]!==void 0&&c++;return c===u}function s(l){const c=l.target;c.removeEventListener("dispose",s);const u=e.get(c);u!==void 0&&(e.delete(c),u.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:i,dispose:a}}function Bv(n){const e={};function t(i){if(e[i]!==void 0)return e[i];const r=n.getExtension(i);return e[i]=r,r}return{has:function(i){return t(i)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(i){const r=t(i);return r===null&&Us("WebGLRenderer: "+i+" extension not supported."),r}}}function zv(n,e,t,i){const r={},s=new WeakMap;function a(d){const x=d.target;x.index!==null&&e.remove(x.index);for(const S in x.attributes)e.remove(x.attributes[S]);x.removeEventListener("dispose",a),delete r[x.id];const g=s.get(x);g&&(e.remove(g),s.delete(x)),i.releaseStatesOfGeometry(x),x.isInstancedBufferGeometry===!0&&delete x._maxInstanceCount,t.memory.geometries--}function l(d,x){return r[x.id]===!0||(x.addEventListener("dispose",a),r[x.id]=!0,t.memory.geometries++),x}function c(d){const x=d.attributes;for(const g in x)e.update(x[g],n.ARRAY_BUFFER)}function u(d){const x=[],g=d.index,S=d.attributes.position;let T=0;if(g!==null){const C=g.array;T=g.version;for(let R=0,A=C.length;R<A;R+=3){const O=C[R+0],L=C[R+1],B=C[R+2];x.push(O,L,L,B,B,O)}}else if(S!==void 0){const C=S.array;T=S.version;for(let R=0,A=C.length/3-1;R<A;R+=3){const O=R+0,L=R+1,B=R+2;x.push(O,L,L,B,B,O)}}else return;const _=new($h(x)?nd:td)(x,1);_.version=T;const m=s.get(d);m&&e.remove(m),s.set(d,_)}function h(d){const x=s.get(d);if(x){const g=d.index;g!==null&&x.version<g.version&&u(d)}else u(d);return s.get(d)}return{get:l,update:c,getWireframeAttribute:h}}function Vv(n,e,t){let i;function r(x){i=x}let s,a;function l(x){s=x.type,a=x.bytesPerElement}function c(x,g){n.drawElements(i,g,s,x*a),t.update(g,i,1)}function u(x,g,S){S!==0&&(n.drawElementsInstanced(i,g,s,x*a,S),t.update(g,i,S))}function h(x,g,S){if(S===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,g,0,s,x,0,S);let _=0;for(let m=0;m<S;m++)_+=g[m];t.update(_,i,1)}function d(x,g,S,T){if(S===0)return;const _=e.get("WEBGL_multi_draw");if(_===null)for(let m=0;m<x.length;m++)u(x[m]/a,g[m],T[m]);else{_.multiDrawElementsInstancedWEBGL(i,g,0,s,x,0,T,0,S);let m=0;for(let C=0;C<S;C++)m+=g[C]*T[C];t.update(m,i,1)}}this.setMode=r,this.setIndex=l,this.render=c,this.renderInstances=u,this.renderMultiDraw=h,this.renderMultiDrawInstances=d}function Hv(n){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,a,l){switch(t.calls++,a){case n.TRIANGLES:t.triangles+=l*(s/3);break;case n.LINES:t.lines+=l*(s/2);break;case n.LINE_STRIP:t.lines+=l*(s-1);break;case n.LINE_LOOP:t.lines+=l*s;break;case n.POINTS:t.points+=l*s;break;default:zt("WebGLInfo: Unknown draw mode:",a);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:i}}function Gv(n,e,t){const i=new WeakMap,r=new At;function s(a,l,c){const u=a.morphTargetInfluences,h=l.morphAttributes.position||l.morphAttributes.normal||l.morphAttributes.color,d=h!==void 0?h.length:0;let x=i.get(l);if(x===void 0||x.count!==d){let E=function(){W.dispose(),i.delete(l),l.removeEventListener("dispose",E)};var g=E;x!==void 0&&x.texture.dispose();const S=l.morphAttributes.position!==void 0,T=l.morphAttributes.normal!==void 0,_=l.morphAttributes.color!==void 0,m=l.morphAttributes.position||[],C=l.morphAttributes.normal||[],R=l.morphAttributes.color||[];let A=0;S===!0&&(A=1),T===!0&&(A=2),_===!0&&(A=3);let O=l.attributes.position.count*A,L=1;O>e.maxTextureSize&&(L=Math.ceil(O/e.maxTextureSize),O=e.maxTextureSize);const B=new Float32Array(O*L*4*d),W=new Zh(B,O,L,d);W.type=gi,W.needsUpdate=!0;const P=A*4;for(let z=0;z<d;z++){const Z=m[z],ie=C[z],de=R[z],ue=O*L*4*z;for(let ce=0;ce<Z.count;ce++){const fe=ce*P;S===!0&&(r.fromBufferAttribute(Z,ce),B[ue+fe+0]=r.x,B[ue+fe+1]=r.y,B[ue+fe+2]=r.z,B[ue+fe+3]=0),T===!0&&(r.fromBufferAttribute(ie,ce),B[ue+fe+4]=r.x,B[ue+fe+5]=r.y,B[ue+fe+6]=r.z,B[ue+fe+7]=0),_===!0&&(r.fromBufferAttribute(de,ce),B[ue+fe+8]=r.x,B[ue+fe+9]=r.y,B[ue+fe+10]=r.z,B[ue+fe+11]=de.itemSize===4?r.w:1)}}x={count:d,texture:W,size:new dt(O,L)},i.set(l,x),l.addEventListener("dispose",E)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)c.getUniforms().setValue(n,"morphTexture",a.morphTexture,t);else{let S=0;for(let _=0;_<u.length;_++)S+=u[_];const T=l.morphTargetsRelative?1:1-S;c.getUniforms().setValue(n,"morphTargetBaseInfluence",T),c.getUniforms().setValue(n,"morphTargetInfluences",u)}c.getUniforms().setValue(n,"morphTargetsTexture",x.texture,t),c.getUniforms().setValue(n,"morphTargetsTextureSize",x.size)}return{update:s}}function kv(n,e,t,i){let r=new WeakMap;function s(c){const u=i.render.frame,h=c.geometry,d=e.get(c,h);if(r.get(d)!==u&&(e.update(d),r.set(d,u)),c.isInstancedMesh&&(c.hasEventListener("dispose",l)===!1&&c.addEventListener("dispose",l),r.get(c)!==u&&(t.update(c.instanceMatrix,n.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,n.ARRAY_BUFFER),r.set(c,u))),c.isSkinnedMesh){const x=c.skeleton;r.get(x)!==u&&(x.update(),r.set(x,u))}return d}function a(){r=new WeakMap}function l(c){const u=c.target;u.removeEventListener("dispose",l),t.remove(u.instanceMatrix),u.instanceColor!==null&&t.remove(u.instanceColor)}return{update:s,dispose:a}}const ud=new cn,uf=new od(1,1),fd=new Zh,hd=new fx,dd=new sd,ff=[],hf=[],df=new Float32Array(16),pf=new Float32Array(9),mf=new Float32Array(4);function Qr(n,e,t){const i=n[0];if(i<=0||i>0)return n;const r=e*t;let s=ff[r];if(s===void 0&&(s=new Float32Array(r),ff[r]=s),e!==0){i.toArray(s,0);for(let a=1,l=0;a!==e;++a)l+=t,n[a].toArray(s,l)}return s}function Gt(n,e){if(n.length!==e.length)return!1;for(let t=0,i=n.length;t<i;t++)if(n[t]!==e[t])return!1;return!0}function kt(n,e){for(let t=0,i=e.length;t<i;t++)n[t]=e[t]}function $o(n,e){let t=hf[e];t===void 0&&(t=new Int32Array(e),hf[e]=t);for(let i=0;i!==e;++i)t[i]=n.allocateTextureUnit();return t}function Wv(n,e){const t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function Xv(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Gt(t,e))return;n.uniform2fv(this.addr,e),kt(t,e)}}function jv(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Gt(t,e))return;n.uniform3fv(this.addr,e),kt(t,e)}}function qv(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Gt(t,e))return;n.uniform4fv(this.addr,e),kt(t,e)}}function Yv(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(Gt(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),kt(t,e)}else{if(Gt(t,i))return;mf.set(i),n.uniformMatrix2fv(this.addr,!1,mf),kt(t,i)}}function Kv(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(Gt(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),kt(t,e)}else{if(Gt(t,i))return;pf.set(i),n.uniformMatrix3fv(this.addr,!1,pf),kt(t,i)}}function $v(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(Gt(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),kt(t,e)}else{if(Gt(t,i))return;df.set(i),n.uniformMatrix4fv(this.addr,!1,df),kt(t,i)}}function Zv(n,e){const t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function Jv(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Gt(t,e))return;n.uniform2iv(this.addr,e),kt(t,e)}}function Qv(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Gt(t,e))return;n.uniform3iv(this.addr,e),kt(t,e)}}function eM(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Gt(t,e))return;n.uniform4iv(this.addr,e),kt(t,e)}}function tM(n,e){const t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function nM(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Gt(t,e))return;n.uniform2uiv(this.addr,e),kt(t,e)}}function iM(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Gt(t,e))return;n.uniform3uiv(this.addr,e),kt(t,e)}}function rM(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Gt(t,e))return;n.uniform4uiv(this.addr,e),kt(t,e)}}function sM(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r);let s;this.type===n.SAMPLER_2D_SHADOW?(uf.compareFunction=Kh,s=uf):s=ud,t.setTexture2D(e||s,r)}function oM(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture3D(e||hd,r)}function aM(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTextureCube(e||dd,r)}function lM(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture2DArray(e||fd,r)}function cM(n){switch(n){case 5126:return Wv;case 35664:return Xv;case 35665:return jv;case 35666:return qv;case 35674:return Yv;case 35675:return Kv;case 35676:return $v;case 5124:case 35670:return Zv;case 35667:case 35671:return Jv;case 35668:case 35672:return Qv;case 35669:case 35673:return eM;case 5125:return tM;case 36294:return nM;case 36295:return iM;case 36296:return rM;case 35678:case 36198:case 36298:case 36306:case 35682:return sM;case 35679:case 36299:case 36307:return oM;case 35680:case 36300:case 36308:case 36293:return aM;case 36289:case 36303:case 36311:case 36292:return lM}}function uM(n,e){n.uniform1fv(this.addr,e)}function fM(n,e){const t=Qr(e,this.size,2);n.uniform2fv(this.addr,t)}function hM(n,e){const t=Qr(e,this.size,3);n.uniform3fv(this.addr,t)}function dM(n,e){const t=Qr(e,this.size,4);n.uniform4fv(this.addr,t)}function pM(n,e){const t=Qr(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function mM(n,e){const t=Qr(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function xM(n,e){const t=Qr(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function gM(n,e){n.uniform1iv(this.addr,e)}function _M(n,e){n.uniform2iv(this.addr,e)}function vM(n,e){n.uniform3iv(this.addr,e)}function MM(n,e){n.uniform4iv(this.addr,e)}function SM(n,e){n.uniform1uiv(this.addr,e)}function bM(n,e){n.uniform2uiv(this.addr,e)}function yM(n,e){n.uniform3uiv(this.addr,e)}function EM(n,e){n.uniform4uiv(this.addr,e)}function TM(n,e,t){const i=this.cache,r=e.length,s=$o(t,r);Gt(i,s)||(n.uniform1iv(this.addr,s),kt(i,s));for(let a=0;a!==r;++a)t.setTexture2D(e[a]||ud,s[a])}function AM(n,e,t){const i=this.cache,r=e.length,s=$o(t,r);Gt(i,s)||(n.uniform1iv(this.addr,s),kt(i,s));for(let a=0;a!==r;++a)t.setTexture3D(e[a]||hd,s[a])}function wM(n,e,t){const i=this.cache,r=e.length,s=$o(t,r);Gt(i,s)||(n.uniform1iv(this.addr,s),kt(i,s));for(let a=0;a!==r;++a)t.setTextureCube(e[a]||dd,s[a])}function RM(n,e,t){const i=this.cache,r=e.length,s=$o(t,r);Gt(i,s)||(n.uniform1iv(this.addr,s),kt(i,s));for(let a=0;a!==r;++a)t.setTexture2DArray(e[a]||fd,s[a])}function CM(n){switch(n){case 5126:return uM;case 35664:return fM;case 35665:return hM;case 35666:return dM;case 35674:return pM;case 35675:return mM;case 35676:return xM;case 5124:case 35670:return gM;case 35667:case 35671:return _M;case 35668:case 35672:return vM;case 35669:case 35673:return MM;case 5125:return SM;case 36294:return bM;case 36295:return yM;case 36296:return EM;case 35678:case 36198:case 36298:case 36306:case 35682:return TM;case 35679:case 36299:case 36307:return AM;case 35680:case 36300:case 36308:case 36293:return wM;case 36289:case 36303:case 36311:case 36292:return RM}}class PM{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=cM(t.type)}}class DM{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=CM(t.type)}}class LM{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){const r=this.seq;for(let s=0,a=r.length;s!==a;++s){const l=r[s];l.setValue(e,t[l.id],i)}}}const Ya=/(\w+)(\])?(\[|\.)?/g;function xf(n,e){n.seq.push(e),n.map[e.id]=e}function UM(n,e,t){const i=n.name,r=i.length;for(Ya.lastIndex=0;;){const s=Ya.exec(i),a=Ya.lastIndex;let l=s[1];const c=s[2]==="]",u=s[3];if(c&&(l=l|0),u===void 0||u==="["&&a+2===r){xf(t,u===void 0?new PM(l,n,e):new DM(l,n,e));break}else{let d=t.map[l];d===void 0&&(d=new LM(l),xf(t,d)),t=d}}}class Ao{constructor(e,t){this.seq=[],this.map={};const i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<i;++r){const s=e.getActiveUniform(t,r),a=e.getUniformLocation(t,s.name);UM(s,a,this)}}setValue(e,t,i,r){const s=this.map[t];s!==void 0&&s.setValue(e,i,r)}setOptional(e,t,i){const r=t[i];r!==void 0&&this.setValue(e,i,r)}static upload(e,t,i,r){for(let s=0,a=t.length;s!==a;++s){const l=t[s],c=i[l.id];c.needsUpdate!==!1&&l.setValue(e,c.value,r)}}static seqWithValue(e,t){const i=[];for(let r=0,s=e.length;r!==s;++r){const a=e[r];a.id in t&&i.push(a)}return i}}function gf(n,e,t){const i=n.createShader(e);return n.shaderSource(i,t),n.compileShader(i),i}const IM=37297;let FM=0;function NM(n,e){const t=n.split(`
`),i=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let a=r;a<s;a++){const l=a+1;i.push(`${l===e?">":" "} ${l}: ${t[a]}`)}return i.join(`
`)}const _f=new ot;function OM(n){vt._getMatrix(_f,vt.workingColorSpace,n);const e=`mat3( ${_f.elements.map(t=>t.toFixed(4))} )`;switch(vt.getTransfer(n)){case Uo:return[e,"LinearTransferOETF"];case Tt:return[e,"sRGBTransferOETF"];default:return it("WebGLProgram: Unsupported color space: ",n),[e,"LinearTransferOETF"]}}function vf(n,e,t){const i=n.getShaderParameter(e,n.COMPILE_STATUS),s=(n.getShaderInfoLog(e)||"").trim();if(i&&s==="")return"";const a=/ERROR: 0:(\d+)/.exec(s);if(a){const l=parseInt(a[1]);return t.toUpperCase()+`

`+s+`

`+NM(n.getShaderSource(e),l)}else return s}function BM(n,e){const t=OM(e);return[`vec4 ${n}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function zM(n,e){let t;switch(e){case zm:t="Linear";break;case Vm:t="Reinhard";break;case Hm:t="Cineon";break;case Gm:t="ACESFilmic";break;case Wm:t="AgX";break;case Xm:t="Neutral";break;case km:t="Custom";break;default:it("WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const go=new Y;function VM(){vt.getLuminanceCoefficients(go);const n=go.x.toFixed(4),e=go.y.toFixed(4),t=go.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}function KM(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===Bh?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===_m?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===fi&&(e="SHADOWMAP_TYPE_VSM"),e}function $M(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case jr:case qr:e="ENVMAP_TYPE_CUBE";break;case jo:e="ENVMAP_TYPE_CUBE_UV";break}return e}function ZM(n){let e="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case qr:e="ENVMAP_MODE_REFRACTION";break}return e}function JM(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case zh:e="ENVMAP_BLENDING_MULTIPLY";break;case Om:e="ENVMAP_BLENDING_MIX";break;case Bm:e="ENVMAP_BLENDING_ADD";break}return e}function QM(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:i,maxMip:t}}function eS(n,e,t,i){const r=n.getContext(),s=t.defines;let a=t.vertexShader,l=t.fragmentShader;const c=KM(t),u=$M(t),h=ZM(t),d=JM(t),x=QM(t),g=HM(t),S=GM(s),T=r.createProgram();let _,m,C=t.glslVersion?"#version "+t.glslVersion+`
...
`+p.getProgramInfoLog(I));M=o.s=I,p.useProgram(M),D=p.getUniformLocation(M,"sampler0"),o.l={O:p.getAttribLocation(M,"aVertex"),N:p.getAttribLocation(M,"aTex"),xa:D},o.v=p.createBuffer(),p.bindBuffer(p.ARRAY_BUFFER,o.v),p.enableVertexAttribArray(o.l.O),p.vertexAttribPointer(o.l.O,2,p.FLOAT,!1,0,0),p.bufferData(p.ARRAY_BUFFER,new Float32Array([-1,-1,-1,1,1,1,1,-1]),p.STATIC_DRAW),p.bindBuffer(p.ARRAY_BUFFER,null),o.u=p.createBuffer(),p.bindBuffer(p.ARRAY_BUFFER,o.u),p.enableVertexAttribArray(o.l.N),p.vertexAttribPointer(o.l.N,2,p.FLOAT,!1,0,0),p.bufferData(p.ARRAY_BUFFER,new Float32Array([0,1,0,0,1,0,1,1]),p.STATIC_DRAW),p.bindBuffer(p.ARRAY_BUFFER,null),p.uniform1i(D,0)}M=o.l,p.useProgram(o.s),p.canvas.width=f.width,p.canvas.height=f.height,p.viewport(0,0,f.width,f.height),p.activeTexture(p.TEXTURE0),o.i.bindTexture2d(f.glName),p.enableVertexAttribArray(M.O),p.bindBuffer(p.ARRAY_BUFFER,o.v),p.vertexAttribPointer(M.O,2,p.FLOAT,!1,0,0),p.enableVertexAttribArray(M.N),p.bindBuffer(p.ARRAY_BUFFER,o.u),p.vertexAttribPointer(M.N,2,p.FLOAT,!1,0,0),p.bindFramebuffer(p.DRAW_FRAMEBUFFER?p.DRAW_FRAMEBUFFER:p.FRAMEBUFFER,null),p.clearColor(0,0,0,0),p.clear(p.COLOR_BUFFER_BIT),p.colorMask(!0,!0,!0,!0),p.drawArrays(p.TRIANGLE_FAN,0,4),p.disableVertexAttribArray(M.O),p.disableVertexAttribArray(M.N),p.bindBuffer(p.ARRAY_BUFFER,null),o.i.bindTexture2d(0)}function Rd(o){this.h=o}var Cd=new Uint8Array([0,97,115,109,1,0,0,0,1,4,1,96,0,0,3,2,1,0,10,9,1,7,0,65,0,253,15,26,11]);function Pd(o,f){return f+o}function qc(o,f){window[o]=f}function Dd(o){var f=document.createElement("script");return f.setAttribute("src",o),f.setAttribute("crossorigin","anonymous"),new Promise(function(p){f.addEventListener("load",function(){p()},!1),f.addEventListener("error",function(){p()},!1),document.body.appendChild(f)})}function Ld(){return z(function(o){switch(o.h){case 1:return o.s=2,A(o,WebAssembly.instantiate(Cd),4);case 4:o.h=3,o.s=0;break;case 2:return o.s=0,o.l=null,o.return(!1);case 3:return o.return(!0)}})}function ia(o){if(this.h=o,this.listeners={},this.l={},this.L={},this.s={},this.v={},this.M=this.u=this.ga=!0,this.I=Promise.resolve(),this.fa="",this.D={},this.locateFile=o&&o.locateFile||Pd,typeof window=="object")var f=window.location.pathname.toString().substring(0,window.location.pathname.toString().lastIndexOf("/"))+"/";else if(typeof location<"u")f=location.pathname.toString().substring(0,location.pathname.toString().lastIndexOf("/"))+"/";else throw Error("solutions can only be loaded on a web page or in a web worker");if(this.ha=f,o.options){f=l(Object.keys(o.options));for(var p=f.next();!p.done;p=f.next()){p=p.value;var M=o.options[p].default;M!==void 0&&(this.l[p]=typeof M=="function"?M():M)}}}n=ia.prototype,n.close=function(){return this.j&&this.j.delete(),Promise.resolve()};function Ud(o){var f,p,M,D,I,U,G,Q,Me,Pe,Qe;return z(function(je){switch(je.h){case 1:return o.ga?(f=o.h.files===void 0?[]:typeof o.h.files=="function"?o.h.files(o.l):o.h.files,A(je,Ld(),2)):je.return();case 2:if(p=je.i,typeof window=="object")return qc("createMediapipeSolutionsWasm",{locateFile:o.locateFile}),qc("createMediapipeSolutionsPackedAssets",{locateFile:o.locateFile}),U=f.filter(function(Ie){return Ie.data!==void 0}),G=f.filter(function(Ie){return Ie.data===void 0}),Q=Promise.all(U.map(function(Ie){var et=Xs(o,Ie.url);if(Ie.path!==void 0){var ct=Ie.path;et=et.then(function(Lt){return o.overrideFile(ct,Lt),Promise.resolve(Lt)})}return et})),Me=Promise.all(G.map(function(Ie){return Ie.simd===void 0||Ie.simd&&p||!Ie.simd&&!p?Dd(o.locateFile(Ie.url,o.ha)):Promise.resolve()})).then(function(){var Ie,et,ct;return z(function(Lt){if(Lt.h==1)return Ie=window.createMediapipeSolutionsWasm,et=window.createMediapipeSolutionsPackedAssets,ct=o,A(Lt,Ie(et),2);ct.i=Lt.i,Lt.h=0})}),Pe=(function(){return z(function(Ie){return o.h.graph&&o.h.graph.url?Ie=A(Ie,Xs(o,o.h.graph.url),0):(Ie.h=0,Ie=void 0),Ie})})(),A(je,Promise.all([Me,Q,Pe]),7);if(typeof importScripts!="function")throw Error("solutions can only be loaded on a web page or in a web worker");return M=f.filter(function(Ie){return Ie.simd===void 0||Ie.simd&&p||!Ie.simd&&!p}).map(function(Ie){return o.locateFile(Ie.url,o.ha)}),importScripts.apply(null,c(M)),D=o,A(je,createMediapipeSolutionsWasm(Module),6);case 6:D.i=je.i,o.m=new OffscreenCanvas(1,1),o.i.canvas=o.m,I=o.i.GL.createContext(o.m,{antialias:!1,alpha:!1,ua:typeof WebGL2RenderingContext<"u"?2:1}),o.i.GL.makeContextCurrent(I),je.h=4;break;case 7:if(o.m=document.createElement("canvas"),Qe=o.m.getContext("webgl2",{}),!Qe&&(Qe=o.m.getContext("webgl",{}),!Qe))return alert("Failed to create WebGL canvas context when passing video frame."),je.return();o.K=Qe,o.i.canvas=o.m,o.i.createContext(o.m,!0,!0,{});case 4:o.j=new o.i.SolutionWasm,o.ga=!1,je.h=0}})}function Id(o){var f,p,M,D,I,U,G,Q;return z(function(Me){if(Me.h==1){if(o.h.graph&&o.h.graph.url&&o.fa===o.h.graph.url)return Me.return();if(o.u=!0,!o.h.graph||!o.h.graph.url){Me.h=2;return}return o.fa=o.h.graph.url,A(Me,Xs(o,o.h.graph.url),3)}for(Me.h!=2&&(f=Me.i,o.j.loadGraph(f)),p=l(Object.keys(o.D)),M=p.next();!M.done;M=p.next())D=M.value,o.j.overrideFile(D,o.D[D]);if(o.D={},o.h.listeners)for(I=l(o.h.listeners),U=I.next();!U.done;U=I.next())G=U.value,Bd(o,G);Q=o.l,o.l={},o.setOptions(Q),Me.h=0})}n.reset=function(){var o=this;return z(function(f){o.j&&(o.j.reset(),o.s={},o.v={}),f.h=0})},n.setOptions=function(o,f){var p=this;if(f=f||this.h.options){for(var M=[],D=[],I={},U=l(Object.keys(o)),G=U.next();!G.done;I={X:I.X,Y:I.Y},G=U.next())if(G=G.value,!(G in this.l&&this.l[G]===o[G])){this.l[G]=o[G];var Q=f[G];Q!==void 0&&(Q.onChange&&(I.X=Q.onChange,I.Y=o[G],M.push((function(Me){return function(){var Pe;return z(function(Qe){if(Qe.h==1)return A(Qe,Me.X(Me.Y),2);Pe=Qe.i,Pe===!0&&(p.u=!0),Qe.h=0})}})(I))),Q.graphOptionXref&&(G=Object.assign({},{calculatorName:"",calculatorIndex:0},Q.graphOptionXref,{valueNumber:Q.type===1?o[G]:0,valueBoolean:Q.type===0?o[G]:!1,valueString:Q.type===2?o[G]:""}),D.push(G)))}(M.length!==0||D.length!==0)&&(this.u=!0,this.H=(this.H===void 0?[]:this.H).concat(D),this.F=(this.F===void 0?[]:this.F).concat(M))}};function Fd(o){var f,p,M,D,I,U,G;return z(function(Q){switch(Q.h){case 1:if(!o.u)return Q.return();if(!o.F){Q.h=2;break}f=l(o.F),p=f.next();case 3:if(p.done){Q.h=5;break}return M=p.value,A(Q,M(),4);case 4:p=f.next(),Q.h=3;break;case 5:o.F=void 0;case 2:if(o.H){for(D=new o.i.GraphOptionChangeRequestList,I=l(o.H),U=I.next();!U.done;U=I.next())G=U.value,D.push_back(G);o.j.changeOptions(D),D.delete(),o.H=void 0}o.u=!1,Q.h=0}})}n.initialize=function(){var o=this;return z(function(f){return f.h==1?A(f,Ud(o),2):f.h!=3?A(f,Id(o),3):A(f,Fd(o),0)})};function Xs(o,f){var p,M;return z(function(D){return f in o.L?D.return(o.L[f]):(p=o.locateFile(f,""),M=fetch(p).then(function(I){return I.arrayBuffer()}),o.L[f]=M,D.return(M))})}n.overrideFile=function(o,f){this.j?this.j.overrideFile(o,f):this.D[o]=f},n.clearOverriddenFiles=function(){this.D={},this.j&&this.j.clearOverriddenFiles()},n.send=function(o,f){var p=this,M,D,I,U,G,Q,Me,Pe,Qe;return z(function(je){switch(je.h){case 1:return p.h.inputs?(M=1e3*(f??performance.now()),A(je,p.I,2)):je.return();case 2:return A(je,p.initialize(),3);case 3:for(D=new p.i.PacketDataList,I=l(Object.keys(o)),U=I.next();!U.done;U=I.next())if(G=U.value,Q=p.h.inputs[G]){e:{var Ie=o[G];switch(Q.type){case"video":var et=p.s[Q.stream];if(et||(et=new na(p.i,p.K),p.s[Q.stream]=et),et.m===0&&(et.m=et.i.createTexture()),typeof HTMLVideoElement<"u"&&Ie instanceof HTMLVideoElement)var ct=Ie.videoWidth,Lt=Ie.videoHeight;else typeof HTMLImageElement<"u"&&Ie instanceof HTMLImageElement?(ct=Ie.naturalWidth,Lt=Ie.naturalHeight):(ct=Ie.width,Lt=Ie.height);Lt={glName:et.m,width:ct,height:Lt},ct=et.h,ct.canvas.width=Lt.width,ct.canvas.height=Lt.height,ct.activeTexture(ct.TEXTURE0),et.i.bindTexture2d(et.m),ct.texImage2D(ct.TEXTURE_2D,0,ct.RGBA,ct.RGBA,ct.UNSIGNED_BYTE,Ie),et.i.bindTexture2d(0),et=Lt;break e;case"detections":for(et=p.s[Q.stream],et||(et=new Rd(p.i),p.s[Q.stream]=et),et.data||(et.data=new et.h.DetectionListData),et.data.reset(Ie.length),Lt=0;Lt<Ie.length;++Lt){ct=Ie[Lt];var Pt=et.data,Yt=Pt.setBoundingBox,Rn=Lt,fn=ct.la,_t=new Ws;if(Re(_t,1,fn.ra),Re(_t,2,fn.sa),Re(_t,3,fn.height),Re(_t,4,fn.width),Re(_t,5,fn.rotation),y(_t,6,fn.pa),fn=_t.l(),Yt.call(Pt,Rn,fn),ct.ea)for(Pt=0;Pt<ct.ea.length;++Pt){_t=ct.ea[Pt],Yt=et.data,Rn=Yt.addNormalizedLandmark,fn=Lt,_t=Object.assign({},_t,{visibility:_t.visibility?_t.visibility:0});var Kt=new gr;Re(Kt,1,_t.x),Re(Kt,2,_t.y),Re(Kt,3,_t.z),_t.visibility&&Re(Kt,4,_t.visibility),_t=Kt.l(),Rn.call(Yt,fn,_t)}if(ct.ba)for(Pt=0;Pt<ct.ba.length;++Pt)Yt=et.data,Rn=Yt.addClassification,fn=Lt,_t=ct.ba[Pt],Kt=new xr,Re(Kt,2,_t.score),_t.index&&y(Kt,1,_t.index),_t.label&&y(Kt,3,_t.label),_t.displayName&&y(Kt,4,_t.displayName),_t=Kt.l(),Rn.call(Yt,fn,_t)}et=et.data;break e;default:et={}}}switch(Me=et,Pe=Q.stream,Q.type){case"video":D.pushTexture2d(Object.assign({},Me,{stream:Pe,timestamp:M}));break;case"detections":Qe=Me,Qe.stream=Pe,Qe.timestamp=M,D.pushDetectionList(Qe);break;default:throw Error("Unknown input config type: '"+Q.type+"'")}}return p.j.send(D),A(je,p.I,4);case 4:D.delete(),je.h=0}})};function Nd(o,f,p){var M,D,I,U,G,Q,Me,Pe,Qe,je,Ie,et,ct,Lt;return z(function(Pt){switch(Pt.h){case 1:if(!p)return Pt.return(f);for(M={},D=0,I=l(Object.keys(p)),U=I.next();!U.done;U=I.next())G=U.value,Q=p[G],typeof Q!="string"&&Q.type==="texture"&&f[Q.stream]!==void 0&&++D;1<D&&(o.M=!1),Me=l(Object.keys(p)),U=Me.next();case 2:if(U.done){Pt.h=4;break}if(Pe=U.value,Qe=p[Pe],typeof Qe=="string")return ct=M,Lt=Pe,A(Pt,Od(o,Pe,f[Qe]),14);if(je=f[Qe.stream],Qe.type==="detection_list"){if(je){for(var Yt=je.getRectList(),Rn=je.getLandmarksList(),fn=je.getClassificationsList(),_t=[],Kt=0;Kt<Yt.size();++Kt){var Ri=Ad(Yt.get(Kt)),zd=Xe(Ri,1),Vd=Xe(Ri,2),Hd=Xe(Ri,3),Gd=Xe(Ri,4),kd=Xe(Ri,5,0),js=void 0;js=js===void 0?0:js,Ri={la:{ra:zd,sa:Vd,height:Hd,width:Gd,rotation:kd,pa:Oe(_n(Ri,6),js)},ea:Ee(Vc(Rn.get(Kt)),gr,1).map(Wc),ba:kc(Oc(fn.get(Kt)))},_t.push(Ri)}Yt=_t}else Yt=[];M[Pe]=Yt,Pt.h=7;break}if(Qe.type==="proto_list"){if(je){for(Yt=Array(je.size()),Rn=0;Rn<je.size();Rn++)Yt[Rn]=je.get(Rn);je.delete()}else Yt=[];M[Pe]=Yt,Pt.h=7;break}if(je===void 0){Pt.h=3;break}if(Qe.type==="float_list"){M[Pe]=je,Pt.h=7;break}if(Qe.type==="proto"){M[Pe]=je,Pt.h=7;break}if(Qe.type!=="texture")throw Error("Unknown output config type: '"+Qe.type+"'");return Ie=o.v[Pe],Ie||(Ie=new na(o.i,o.K),o.v[Pe]=Ie),A(Pt,jc(Ie,je,o.M),13);case 13:et=Pt.i,M[Pe]=et;case 7:Qe.transform&&M[Pe]&&(M[Pe]=Qe.transform(M[Pe])),Pt.h=3;break;case 14:ct[Lt]=Pt.i;case 3:U=Me.next(),Pt.h=2;break;case 4:return Pt.return(M)}})}function Od(o,f,p){var M;return z(function(D){return typeof p=="number"||p instanceof Uint8Array||p instanceof o.i.Uint8BlobList?D.return(p):p instanceof o.i.Texture2dDataOut?(M=o.v[f],M||(M=new na(o.i,o.K),o.v[f]=M),D.return(jc(M,p,o.M))):D.return(void 0)})}function Bd(o,f){for(var p=f.name||"$",M=[].concat(c(f.wants)),D=new o.i.StringList,I=l(f.wants),U=I.next();!U.done;U=I.next())D.push_back(U.value);I=o.i.PacketListener.implement({onResults:function(G){for(var Q={},Me=0;Me<f.wants.length;++Me)Q[M[Me]]=G.get(Me);var Pe=o.listeners[p];Pe&&(o.I=Nd(o,Q,f.outs).then(function(Qe){Qe=Pe(Qe);for(var je=0;je<f.wants.length;++je){var Ie=Q[M[je]];typeof Ie=="object"&&Ie.hasOwnProperty&&Ie.hasOwnProperty("delete")&&Ie.delete()}Qe&&(o.I=Qe)}))}}),o.j.attachMultiListener(D,I),D.delete()}n.onResults=function(o,f){this.listeners[f||"$"]=o},ue("Solution",ia),ue("OptionType",{BOOL:0,NUMBER:1,ta:2,0:"BOOL",1:"NUMBER",2:"STRING"});function Yc(o){return o===void 0&&(o=0),o===1?"hand_landmark_full.tflite":"hand_landmark_lite.tflite"}function Kc(o){var f=this;o=o||{},this.h=new ia({locateFile:o.locateFile,files:function(p){return[{url:"hands_solution_packed_assets_loader.js"},{simd:!1,url:"hands_solution_wasm_bin.js"},{simd:!0,url:"hands_solution_simd_wasm_bin.js"},{data:!0,url:Yc(p.modelComplexity)}]},graph:{url:"hands.binarypb"},inputs:{image:{type:"video",stream:"input_frames_gpu"}},listeners:[{wants:["multi_hand_landmarks","multi_hand_world_landmarks","image_transformed","multi_handedness"],outs:{image:"image_transformed",multiHandLandmarks:{type:"proto_list",stream:"multi_hand_landmarks",transform:Xc},multiHandWorldLandmarks:{type:"proto_list",stream:"multi_hand_world_landmarks",transform:Xc},multiHandedness:{type:"proto_list",stream:"multi_handedness",transform:function(p){return p.map(function(M){return kc(Oc(M))[0]})}}}}],options:{useCpuInference:{type:0,graphOptionXref:{calculatorType:"InferenceCalculator",fieldName:"use_cpu_inference"},default:typeof window!="object"||window.navigator===void 0?!1:"iPad Simulator;iPhone Simulator;iPod Simulator;iPad;iPhone;iPod".split(";").includes(navigator.platform)||navigator.userAgent.includes("Mac")&&"ontouchend"in document},selfieMode:{type:0,graphOptionXref:{calculatorType:"GlScalerCalculator",calculatorIndex:1,fieldName:"flip_horizontal"}},maxNumHands:{type:1,graphOptionXref:{calculatorType:"ConstantSidePacketCalculator",calculatorName:"ConstantSidePacketCalculator",fieldName:"int_value"}},modelComplexity:{type:1,graphOptionXref:{calculatorType:"ConstantSidePacketCalculator",calculatorName:"ConstantSidePacketCalculatorModelComplexity",fieldName:"int_value"},onChange:function(p){var M,D,I;return z(function(U){return U.h==1?(M=Yc(p),D="third_party/mediapipe/modules/hand_landmark/"+M,A(U,Xs(f.h,M),2)):(I=U.i,f.h.overrideFile(D,I),U.return(!0))})}},minDetectionConfidence:{type:1,graphOptionXref:{calculatorType:"TensorsToDetectionsCalculator",calculatorName:"handlandmarktrackinggpu__palmdetectiongpu__TensorsToDetectionsCalculator",fieldName:"min_score_thresh"}},minTrackingConfidence:{type:1,graphOptionXref:{calculatorType:"ThresholdingCalculator",calculatorName:"handlandmarktrackinggpu__handlandmarkgpu__ThresholdingCalculator",fieldName:"threshold"}}}})}n=Kc.prototype,n.close=function(){return this.h.close(),Promise.resolve()},n.onResults=function(o){this.h.onResults(o)},n.initialize=function(){var o=this;return z(function(f){return A(f,o.h.initialize(),0)})},n.reset=function(){this.h.reset()},n.send=function(o){var f=this;return z(function(p){return A(p,f.h.send(o),0)})},n.setOptions=function(o){this.h.setOptions(o)},ue("Hands",Kc),ue("HAND_CONNECTIONS",[[0,1],[1,2],[2,3],[3,4],[0,5],[5,6],[6,7],[7,8],[5,9],[9,10],[10,11],[11,12],[9,13],[13,14],[14,15],[15,16],[13,17],[0,17],[17,18],[18,19],[19,20]]),ue("VERSION","0.4.1675469240")}).call(Ka)),Ka}var LS=DS();const US={class:"game-container"},IS={class:"panel-header"},FS={class:"control-group"},NS={class:"model-selector"},OS=["onClick"],BS={class:"control-group"},zS={class:"control-group"},VS={class:"status-text"},HS={key:0},GS={class:"score-display"},Cf=.5,Pf=.15,kS=.3,WS=ah({__name:"SnakeGame",setup(n){const e=Ci(null),t=Ci(null),i=Ci(!1),r=Ci(!1),s=Ci(!1),a=Ci(0),l=Ci("#00ff88"),c=Ci("cube"),u=[{label:"Cube",value:"cube"},{label:"Sphere",value:"sphere"},{label:"Tetra",value:"tetra"}];let h,d,x,g;const S=[];let T=Pf;const _=new Y(0,0,0);let m;const C={x:15,y:10,z:5};let R;const A=()=>{i.value=!i.value},O=()=>{document.fullscreenElement?document.exitFullscreen():document.documentElement.requestFullscreen()},L=ae=>{c.value=ae,z()},B=()=>{const ae=new mt(l.value);S.forEach(le=>{le.material.color.set(ae),le.material.emissive.set(ae)})},W=()=>{if(!e.value)return;h=new Dx,h.background=new mt(1118481),h.fog=new Tc(1118481,.02),d=new bn(75,window.innerWidth/window.innerHeight,.1,1e3),d.position.z=20,x=new PS({antialias:!0}),x.setSize(window.innerWidth,window.innerHeight),x.setPixelRatio(window.devicePixelRatio),e.value.appendChild(x.domElement);const ae=new Gx(16777215,.5);h.add(ae);const le=new Vx(16777215,1);le.position.set(10,10,10),h.add(le),E(new Y(0,0,0));for(let Te=0;Te<5;Te++)Z();ie(),window.addEventListener("resize",ue)},P=()=>{switch(c.value){case"sphere":return new Rc(.4,16,16);case"tetra":return new Cc(.5);case"cube":default:return new Jr(.6,.6,.6)}},E=ae=>{const le=P(),Te=new Ju({color:l.value,emissive:l.value,emissiveIntensity:.5,roughness:.4,metalness:.6}),We=new ei(le,Te);We.position.copy(ae),h.add(We),S.push(We)},z=()=>{const ae=S.map(le=>le.position.clone());S.forEach(le=>h.remove(le)),S.length=0,ae.forEach(le=>E(le))},Z=()=>{const ae=S[S.length-1];ae&&E(ae.position.clone())},ie=()=>{m&&h.remove(m);const ae=new wc(.5),le=new Ju({color:16711765,emissive:16711765,emissiveIntensity:.8});m=new ei(ae,le),de(),h.add(m)},de=()=>{m.position.set((Math.random()-.5)*C.x*2,(Math.random()-.5)*C.y*2,(Math.random()-.5)*C.z*2)},ue=()=>{!d||!x||(d.aspect=window.innerWidth/window.innerHeight,d.updateProjectionMatrix(),x.setSize(window.innerWidth,window.innerHeight))},ce=async()=>{if(t.value){R=new LS.Hands({locateFile:ae=>`https://cdn.jsdelivr.net/npm/@mediapipe/hands/${ae}`}),R.setOptions({maxNumHands:1,modelComplexity:1,minDetectionConfidence:.5,minTrackingConfidence:.5}),R.onResults(fe);try{const ae=await navigator.mediaDevices.getUserMedia({video:{facingMode:"user",width:{ideal:640},height:{ideal:480}}});t.value.srcObject=ae,await t.value.play();const le=async()=>{t.value&&!t.value.paused&&!t.value.ended&&await R.send({image:t.value}),requestAnimationFrame(le)};le()}catch(ae){console.error("Error accessing camera:",ae),alert("无法访问摄像头，请检查权限或设备支持情况。")}}},fe=ae=>{if(ae.multiHandLandmarks&&ae.multiHandLandmarks.length>0){r.value=!0;const le=ae.multiHandLandmarks[0],Te=(1-le[8].x)*2-1,We=(1-le[8].y)*2-1;_.x=Te*15,_.y=We*10;const st=le[4],ut=le[8];Math.sqrt(Math.pow(st.x-ut.x,2)+Math.pow(st.y-ut.y,2))<.05?(s.value=!0,T=kS):(s.value=!1,T=Pf)}else r.value=!1},K=()=>{g=requestAnimationFrame(K);const ae=S[0];if(ae){const le=new Y().subVectors(_,ae.position);le.length()>T&&le.normalize().multiplyScalar(T),ae.position.add(le),ae.lookAt(_)}for(let le=S.length-1;le>0;le--){const Te=S[le],We=S[le-1];if(Te&&We){const st=Te.position.distanceTo(We.position);if(st>Cf){const ut=new Y().subVectors(We.position,Te.position).normalize(),pt=st-Cf;Te.position.add(ut.multiplyScalar(pt)),Te.lookAt(We.position)}}}ae&&m&&(ae.position.distanceTo(m.position)<1&&(a.value+=10,Z(),de()),m.rotation.x+=.02,m.rotation.y+=.03),x.render(h,d)};return fh(()=>{W(),ce(),K()}),hh(()=>{cancelAnimationFrame(g),window.removeEventListener("resize",ue),t.value&&t.value.srcObject&&t.value.srcObject.getTracks().forEach(Te=>Te.stop()),x.dispose()}),(ae,le)=>(ys(),da("div",US,[Ot("div",{ref_key:"canvasContainer",ref:e,class:"canvas-container"},null,512),Ot("video",{ref_key:"inputVideo",ref:t,class:"input-video",playsinline:"",style:{display:"none"}},null,512),Ot("div",{class:Br(["ui-panel",{hidden:i.value}])},[Ot("div",IS,[le[1]||(le[1]=Ot("h2",null,"3D Snake Control",-1)),Ot("button",{onClick:A,class:"toggle-btn"},Ur(i.value?"Show":"Hide"),1)]),Ot("div",FS,[le[2]||(le[2]=Ot("label",null,"Snake Model",-1)),Ot("div",NS,[(ys(),da(Xn,null,$p(u,Te=>Ot("button",{key:Te.value,class:Br({active:c.value===Te.value}),onClick:We=>L(Te.value)},Ur(Te.label),11,OS)),64))])]),Ot("div",BS,[le[3]||(le[3]=Ot("label",null,"Snake Color",-1)),Fp(Ot("input",{type:"color","onUpdate:modelValue":le[0]||(le[0]=Te=>l.value=Te),onInput:B},null,544),[[um,l.value]])]),Ot("div",zS,[le[4]||(le[4]=Ot("label",null,"Status",-1)),Ot("div",VS,[Ot("span",{class:Br({active:r.value})},Ur(r.value?"Hand Detected":"No Hand"),3),r.value?(ys(),da("span",HS," | "+Ur(s.value?"Speed Boost!":"Normal Speed"),1)):D0("",!0)])]),Ot("div",{class:"control-group"},[Ot("button",{onClick:O,class:"fullscreen-btn"}," Toggle Fullscreen ")])],2),Ot("div",GS," Score: "+Ur(a.value),1)]))}}),XS=(n,e)=>{const t=n.__vccOpts||n;for(const[i,r]of e)t[i]=r;return t},jS=XS(WS,[["__scopeId","data-v-50d8ee8b"]]),qS=ah({__name:"App",setup(n){return(e,t)=>(ys(),Lh(jS))}});dm(qS).mount("#app");
